    ...
    <section id="home" className="flex md:flex-row flex-col sm:py-16 py-6">
      ...
      >
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          <CiDiscount1 className="w-[32px] h-[32px] text-white" />
          <p
        ...
        >
          Now, with {"<Name>"} you can create and your own website in minutes
          with a simple color pallette and easy to use tools. Save loads of time
          of headaches and start building your website now.
        </p>
      </div>
